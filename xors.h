...
{
	return static_cast<char>(Character ^ (XORKEYZ + Index));
}
...
#define XorChar( String ) ( CXorString<ConstructIndexList<sizeof( String ) - 1>::Result>( String ).decrypt() )
//#define XorChar( String ) ( ecingT<char, ConstructIndexList<sizeof( String ) - 1>::Result>( String ).decrypt() )
#define XorWchar( String ) ( ecingT<wchar_t, ConstructIndexList<(sizeof( String ) - 1) / 2>::Result>( String ).decrypt() )
